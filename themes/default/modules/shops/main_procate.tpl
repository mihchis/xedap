...
<div id="category">
	...
	<div class="panel panel-default">
		...
		<div class="block_defalt">
			<h3><span class="pull-left" href="{LINK_CATALOG}" title="{TITLE_CATALOG}"><p style ="color:#514703">{TITLE_CATALOG}</span></h3>
        ...
        <div class="text-center xemtatca_bnt">
			<a href="{LINK_CATALOG}" title="{TITLE_CATALOG}"><span>Xem các sản phẩm khác <i class="fa fa-caret-right"></i></span></a>
		</div>
	</div>
