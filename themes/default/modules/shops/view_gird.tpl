    ...
    <div class="col-sm-12 col-md-{num}">
        <div class="thumbnail">
            <div style="height: {height}px">
                <a href="{link_pro}" title="{title_pro}"><img src="{img_pro}" alt="{title_pro}" <!-- BEGIN: tooltip_js -->data-content='{intro}' data-rel="tooltip" data-img="{img_pro}"<!-- END: tooltip_js -->class="img-thumbnail" style="height:{height}px;width:{width}px;"></a>
            </div>
            <div class="info_pro">
            	<!-- BEGIN: new -->
            ...
            <div class="caption text-center">
                ...
                <div class="clearfix">
	                ...
	                <!-- BEGIN: wishlist -->
                <a href="javascript:void(0)" title="{TITLE}"data-content='{LANG.wishlist}' data-rel="tooltip" ><button type="button" onclick="wishlist({ID}, this)" class="btn btn-primary btn-xs <!-- BEGIN: disabled -->disabled<!-- END: disabled -->"><i class="fa fa-heartbeat"></i></button></a>
                <!-- END: wishlist -->
                </div>
            </div>
        </div>
