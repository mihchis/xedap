...
<div class="news_column panel panel-default">
	<div class="panel-body">
    <link type="text/css" rel="stylesheet" href="{NV_BASE_SITEURL}themes/{TEMPLATE}/css/tabs.css"/>
    <ul class="tabs_widget_left tabs_left">
	<li class="tabs">
		<a href="#tabs-1">Hỏi đáp</a>
	</li>
	<li class="tabs">
		<a href="#tabs-2">Góp ý</a>
	</li>
</ul>
...
<div id="tabs-2" class="tabs_left_conten">
	<div class="fb-comments" data-href="https://www.facebook.com/nttart" data-colorscheme="light" data-numposts="5" data-width="870"></div>
</div>
